...
import { getSwitchButtonsByDeviceTopic, saveDevice } from '../../../service/device.service';
import './user-add-device.component.css';

const { Step } = Steps;
const imgProductUri = "/image/user/product/";
...
class ProductListComponent extends Component {
    ...
    showProduct = (product, index) => {
        ...
        if (product.type.includes("SW")) {
            ...
            imgSrc = `${imgProductUri}SR.png`;
        } else {
            imgSrc = `${imgProductUri}${product.type}.png`;
        }
        return (
            <Col key={index} span={8} className="add-device__product-col" onClick={() => this.props.handleChooseProduct(product)}>
    ...
    render() {
        ...
        return(
            <Fragment>
                ...
                <Pagination style={{textAlign:'center'}} current={currentPage} pageSize={3} total={productList.length} onChange={this.onChangePage}/>
            </Fragment>
        ...
        return(
            <Fragment>
                <Form autoComplete='off'>
                    ...
                    {product.type.includes("SW") || product.type.includes("SR") ? (
                        <Fragment>
                            <Form.Item label='Logo'>
                                ...
                                {getFieldValue("logo") !== undefined ? <img alt={getFieldValue("logo")} src={`${imgDeviceUri}${getFieldValue("logo")}-icon.png`} style={{width: '5vw', marginRight: '2vw'}}/> : null }
                    ...
                    <Button type="primary" htmlType="submit" size="large" onClick={this.handleSubmitAddDevice}>Thêm Thiết Bị</Button>
                </Form>
