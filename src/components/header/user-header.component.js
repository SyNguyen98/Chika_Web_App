    ...
    return(
      <Header className="app-header user-header">
        ...
        <nav className="app-header__nav">
          <a className="app-header__nav__item" onClick={() => handleChangePage(LINK_USER_HOME)}>
            <img alt='house-icon' src='/image/header/house-icon.png'/>&ensp;Nhà
          </a>
          <a className="app-header__nav__item" onClick={() => handleChangePage(LINK_USER_ROOM)}>
            <img alt='room-icon' src='/image/header/room-icon.png'/>&ensp;Phòng
          </a>
          <a className="app-header__nav__item" onClick={() => handleChangePage(LINK_USER_SCRIPT)}>
            <img alt='script-icon' src='/image/header/script-icon.png'/>&ensp;Kịch bản
          </a>
          <a className="app-header__nav__item" onClick={() => handleChangePage(LINK_USER_CAMERA)}>
