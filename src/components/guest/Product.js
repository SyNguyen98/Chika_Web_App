      ...
      <div className="product">
        ...
        <div className="product_body">
          ...
          <div className="product_body_switch-sensor">
            <h1 onClick={(event) => this.handleClickChangePage(event, LINK_SWITCH_SENSOR)}>CÔNG TẮC<br/>TÍCH HỢP CẢM BIẾN</h1>
            ...
            <Button shape="round" onClick={(event) => this.handleClickChangePage(event, LINK_SWITCH_SENSOR)}>Xem thêm<Icon type="double-right" /></Button>
          </div>
          ...
          <div className="product_body_switch">
            <h1 onClick={(event) => this.handleClickChangePage(event, LINK_SWITCH)}>CÔNG TẮC VIỀN NHÔM</h1>
            <p>Nguồn cấp: 100-240V 50/60Hz<br/>Công suất: 8A/ kênh<br/>Kiểu dáng: Hình vuông/ Hình chữ nhật<br/>Màu sắc: Đen/ Trắng</p>
            <Button shape="round" onClick={(event) => this.handleClickChangePage(event, LINK_SWITCH)}>Xem thêm<Icon type="double-right" /></Button>
          </div>
          ...
          <div className="product_body_module-ir">
            <h1 onClick={(event) => this.handleClickChangePage(event, LINK_MODULE_IR)}>ĐIỀU KHIỂN HỒNG NGOẠI</h1>
            <p>Nguồn cấp: 5VDC/1A<br/>Nhiệt độ hoạt động: 0-50 độ C<br/>Góc điều khiển: 360 độ<br/>Số mã lệnh: lên đến 1000 lệnh</p>
            <Button shape="round" onClick={(event) => this.handleClickChangePage(event, LINK_MODULE_IR)}>Xem thêm<Icon type="double-right" /></Button>
          </div>
          ...
          <div className="product_body_home-controller">
            <h1 onClick={(event) => this.handleClickChangePage(event, LINK_HOME_CONTROLLER)}>BỘ ĐIỀU KHIỂN<br/>TRUNG TÂM</h1>
            <p>Nguồn cấp: 100-240V ~ 50-60Hz<br/>Nhiệt độ hoạt động: 0 - 50ºC<br/>Kích thước: 95,6 x 48,9 x 46mm<br/>Màu sắc: Màu đen</p>
            <Button shape="round" onClick={(event) => this.handleClickChangePage(event, LINK_HOME_CONTROLLER)}>Xem thêm<Icon type="double-right" /></Button>
          </div>
          ...
          <div className="product_body_door-sensor">
            <h1 onClick={(event) => this.handleClickChangePage(event, LINK_DOOR_SENSOR)}>CẢM BIẾN CỬA</h1>
            <p>Nguồn cấp: Pin CR2477 3V 1000mAh<br/>Nhiệt độ hoạt động: 0 – 50ºC<br/>Thời gian Pin: 2 năm</p>
            <Button shape="round" onClick={(event) => this.handleClickChangePage(event, LINK_DOOR_SENSOR)}>Xem thêm<Icon type="double-right" /></Button>
          </div>
          ...
          <div className="product_body_motion-detector">
            <h1 onClick={(event) => this.handleClickChangePage(event, LINK_MOTION_DETECTOR)}>CẢM BIẾN PHÁT HIỆN CHUYỂN ĐỘNG</h1>
            <p>Nguồn cấp: 220V<br/>Nhiệt độ hoạt động: 0 - 50 độ<br/>Góc quét: 100 độ</p>
            <Button shape="round" onClick={(event) => this.handleClickChangePage(event, LINK_MOTION_DETECTOR)}>Xem thêm<Icon type="double-right" /></Button>
          </div>
        </div>
      </div>
    );
