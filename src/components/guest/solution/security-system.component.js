...
import '../../../styles/guest/solution/security-system.component.css';
import { LINK_GG_ASSISTANT, LINK_CONDITIONER_TIVI,
  LINK_ENVIRONMANTAL_CONTROL, LINK_LIGHT_CONTROL, LINK_RGB_LED } from '../../../constant'

const imageUri = '/image/guest/solution/security-system/';

class SecuritySystemComponent extends Component {
    ...
    return (
      <div className="security-system">
        ...
        <div className="security-system_body">
          <img className="security-system_body_supervise-image" alt="an-ninh-qua-dien-thoai" src={`${imageUri}an-ninh-qua-dien-thoai.jpg`} />
          ...
          <img className="security-system_body_door-sensor-image" alt="cong-tac-cam-ung" src={`${imageUri}cam-bien-cua.png`} />
        ...
        <div className="security-system_body">
          <img className="security-system_body_combine-solution-image" alt="cac-thiet-bi-cung-tham-gia-chong-trom" src={`${imageUri}cac-thiet-bi-cung-tham-gia-chong-trom.jpg`} />
        ...
        <div className="security-system_body">
          <img className="security-system_body_lock-control-image" alt="cam-bien-cua" src={`${imageUri}app-chika-an-ninh.png`} />
...
export default withRouter(SecuritySystemComponent);
