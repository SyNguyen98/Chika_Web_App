...
import '../../../styles/guest/supporting/document.component.css';
      ...
      <div className="document">
        ...
        <div className="document_body">
          <Menu className="document_body_menu"
                ...
                mode="inline">
            <Menu.Item className="document_body_menu_item" key="1" onClick={() => this.handleChangeDocument('1')}>
              <p>Tài liệu hướng dẫn</p>
            </Menu.Item>
            <Menu.Divider/>
            <Menu.Item className="document_body_menu_item" key="2" onClick={() => this.handleChangeDocument('2')}>
              <p>Video hướng dẫn</p>
            </Menu.Item>
            <Menu.Divider/>
            <Menu.Item className="document_body_menu_item" key="3" onClick={() => this.handleOpenPdf('/pdf/bang-gia.pdf')}>
