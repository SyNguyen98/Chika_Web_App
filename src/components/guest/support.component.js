      ...
      <div className="supporting">
        <div className="supporting_header">
          <div className="supporting_header_title">
            <img alt="support-icon" src={`${imageUri}support-icon.png`}/>
        ...
        <div className="supporting_body">
          ...
          <Row>
            <Col className="supporting_body_col" span={5} onClick={() => this.handleChangePage(LINK_QUESTION)}>
              <img alt="question" src={`${imageUri}question-icon.png`}/>
              <p>Các câu hỏi<br/>thường gặp</p>
            </Col>
            <Col className="supporting_body_col" span={5} onClick={() => this.handleChangePage(LINK_DOCUMENT)}>
              <img alt="document" src={`${imageUri}document-icon.png`}/>
              <p>Tài liệu hướng dẫn<br/>và phần mềm</p>
            </Col>
            <Col className="supporting_body_col" span={5} onClick={() => this.handleChangePage(LINK_PRODUCT)}>
              <img alt="products" src={`${imageUri}product-icon.png`}/>
...
export default withRouter(SupportComponent);
