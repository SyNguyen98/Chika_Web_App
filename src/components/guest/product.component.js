    ...
    return(
      <div className="product">
        ...
        <div className="product_body">
          <img className="product_body_switch-sensor-image" alt="switch" src="/image/guest/product/cong-tac-tich-hop-cam-bien-cau-thang.png"></img>
          ...
          <img className="product_body_switch-image" alt="switch" src="/image/guest/product/cong-tac-vien-nhom.png"></img>
          ...
          <img className="product_body_module-ir-image" alt="switch" src="/image/guest/product/cam-bien-hong-ngoai.png"></img>
          ...
          <img className="product_body_home-controller-image" alt="switch" src="/image/guest/product/bo-dieu-khien-trung-tam.png"></img>
          ...
          <img className="product_body_door-sensor-image" alt="switch" src="/image/guest/product/cam-bien-cua.png"></img>
          ...
          <img className="product_body_motion-detector-image" alt="switch" src="/image/guest/product/cam-bien-chuyen-dong.png"></img>
