        ...
        <div className="gg-assistant_introduce">
          ...
          <Row className="gg-assistant_introduce_image" gutter={[32, 8]}>
            <Col className="gg-assistant_introduce_gg-home" span={12}>
              <img alt="first-reason" src="/image/gg-assistant/gg-home.png"></img>
              <p>Điều khiển bằng giọng nói tiếng Việt mọi miền</p>
            </Col>
            <Col className="gg-assistant_introduce_smartphone" span={12}>
              <img alt="first-reason" src="/image/gg-assistant/smartphone.png"></img>
              <p>Điều khiển qua smartphone mọi lúc mọi nơi</p>
            </Col>
          </Row>
        </div>

        <div className="gg-assistant-body">
          <img className="gg-assistant-body_open-light-image" alt="ok-google-bat-den" src="/image/gg-assistant/ok-google-bat-den.jpg"></img>
          <div className="gg-assistant-body_open-light">
            <h1>"OK GOOLGE, BẬT ĐÈN"</h1>
            <p>Hệ thống điện chiếu sáng được bật/tắt chỉ với câu lệnh: “Ok Google, bật đèn chùm phòng khách”.
              Trong nháy mắt, hệ thống đèn nhà bạn sẽ được bật lên. Milo giúp bạn thể hiện giọng nói “quyền năng” trong chính ngôi nhà mình.</p>
          </div>

          <img className="gg-assistant-body_open-conditioner-image" alt="ok-google-bat-dieu-hoa" src="/image/gg-assistant/ok-google-bat-dieu-hoa.jpg"></img>
          <div className="gg-assistant-body_open-conditioner">
            <h1>"OK GOOLGE, BẬT ĐIỀU HÒA"</h1>
            <p>Hệ thống rèm hay điều hòa, TV, bình nóng lạnh… cũng sẽ nhanh chóng được điều khiển bằng giọng nói tiếng Việt.</p>
          </div>

          <img className="gg-assistant-body_open-sound-image" alt="ok-google-bat-nhac" src="/image/gg-assistant/ok-google-bat-nhac.jpg"></img>
          <div className="gg-assistant-body_open-sound">
            <h1>"OK GOOLGE, BẬT NHẠC"</h1>
          ...
          <img className="gg-assistant-body_design-image" alt="ok-google-bat-nhac" src="/image/gg-assistant/gg-home-design.png"></img>
          <div className="gg-assistant-body_design">
            <h1>THIẾT KẾ TINH TẾ</h1>
            <p>Màu sắc sang trọng, tinh tế, luxury trên từng đường nét.</p>
          </div>
        </div>

        <div className="gg-assistant-footer">
          <h1>CÁC GIẢI PHÁP KHÁC</h1>
          <Row className="gg-assistant-footer_row">
            <Col className="gg-assistant-footer_col" span={8}>
