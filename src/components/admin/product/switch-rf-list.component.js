...
import { getAllSwitchRf, saveSwitchRf, deleteSwitchRf } from '../../../service/product.service';
import TableComponent from '../table.component';

class SwitchRfListComponent extends Component {
  constructor(props) {
      super(props);
      this.state = {
        switchRfList: [],
...
export default withRouter(SwitchRfListComponent);