...
export default class AdminChangePassComponent extends Component {
  componentDidMount() {
    window.scrollTo(0, 0);
  }
  ...
  render() {
    ...
    return(
      <div className="admin-setting__change-password">
  ...
  render() {
    ...
    return (
      <Form onSubmit={this.handleSubmit} autoComplete="off">
        ...
        <Button type="primary" htmlType="submit" size="large" style={{width: '50%', marginLeft: '10vw'}}>Đổi mật khẩu</Button>
      </Form>
    );
  }
}