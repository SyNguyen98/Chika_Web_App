...
import "./light-control.css"

import {LIGHT_CONTROL_IMG_URI} from "../../../../constant/uri";
    ...
    return (
      <Fragment className="light-control">
        <div className="light-control-header">
          <img alt="light-control-header" src={`${LIGHT_CONTROL_IMG_URI}banner-chieu-sang.jpg`} />
        ...
        <Row className="light-control__row light-control__row1" gutter={40}>
          <Col className="light-control__row1__col1" span={12}>
            <img alt="chieu-sang-thong-minh-qua-dien-thoai" src={`${LIGHT_CONTROL_IMG_URI}chieu-sang-thong-minh-qua-dien-thoai.jpg`}/>
          </Col>
        ...
        <div className="light-control__panel switch-2in1-panel">
          <img alt="switch-2in1-panel" src={`${LIGHT_CONTROL_IMG_URI}cong-tac-2in1.jpg`}/>
        ...
        <Row className="light-control__row light-control__row2" gutter={40}>
          ...
          <Col className="light-control__row2__col2" span={12}>
            <img alt="cong-tac-cam-ung" src={`${LIGHT_CONTROL_IMG_URI}cong-tac-cam-ung.png`}/>
          </Col>
        </Row>

        <div className="light-control__auto-light">
          <h1>MỞ CỬA, ĐÈN TỰ SÁNG</h1>
          <img alt="mo-cua-den-sang" src={`${LIGHT_CONTROL_IMG_URI}mo-cua-den-sang.jpg`}/>
        </div>

        <Row className="light-control__row light-control__row3" gutter={40}>
          <Col className="light-control__row3__col1" span={12}>
            <img alt="hen-gio-chieu-sang" src={`${LIGHT_CONTROL_IMG_URI}hen-gio-chieu-sang.jpg`}/>
          </Col>
        ...
        <div className="light-control__panel motion-detector-panel">
          <img alt="motion-detector-panel" src={`${LIGHT_CONTROL_IMG_URI}cam-bien-chuyen-dong.jpg`}/>
        ...
        <Row className="light-control__row light-control__row4" gutter={40}>
          ...
          <Col className="light-control__row4__col2" span={12}>
            <img alt="cam-bien-cua" src={`${LIGHT_CONTROL_IMG_URI}cam-bien-cua.png`}/>
          </Col>
        </Row>
