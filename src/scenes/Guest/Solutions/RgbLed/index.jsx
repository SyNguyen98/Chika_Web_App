...
import {RGB_LED_IMG_URI} from "../../../../constant/uri";

export default class RgbLedComponent extends Component {
    ...
    return (
      <Fragment className="rgb-led">
        <div className="rgb-led-header">
          <img alt="banner-led-16-trieu-mau" src={`${RGB_LED_IMG_URI}banner-led-16-trieu-mau.jpg`} />
        ...
        <Row className="rgb-led__row rgb-led__row1" gutter={40}>
          <Col className="rgb-led__row1__col1" span={12}>
            <img alt="khong-gian-da-mau-sac" src={`${RGB_LED_IMG_URI}khong-gian-da-mau-sac.jpg`}/>
          </Col>
        ...
        <div className="rgb-led__panel change-color-panel">
          <img alt="change-color-panel" src={`${RGB_LED_IMG_URI}doi-mau-sac.jpg`}/>
        ...
        <Row className="rgb-led__row rgb-led__row2" gutter={40}>
          ...
          <Col className="rgb-led__row2__col2" span={12}>
            <img alt="led-ket-hop-cung-thiet-bi-khac" src={`${RGB_LED_IMG_URI}led-ket-hop-cung-thiet-bi-khac.jpg`}/>
          </Col>
        </Row>

        <div className="rgb-led__timer">
          <h1>HẸN GIỜ ĐỔI MÀU SẮC</h1>
          <img alt="hen-gio-doi-mau-sac-led" src={`${RGB_LED_IMG_URI}hen-gio-doi-mau-sac-led.jpg`}/>
        </div>
