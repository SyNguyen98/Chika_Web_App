...
import "./conditioner-tivi.css"

import {CONDITIONER_TIVI_IMG_URI} from "../../../../constant/uri";


export default class ConditionerTiviComponent extends Component {
    ...
    return (
      <Fragment className="conditioner-tivi">
        <div className="conditioner-tivi-header">
          <img alt="conditioner-tivi-header" src={`${CONDITIONER_TIVI_IMG_URI}dieu-khien-tv-banner.jpg`} />
        ...
        <Row className="conditioner-tivi__row google__row1" gutter={40}>
          <Col className="conditioner-tivi__row1__col1" span={12}>
            <img alt="ok-google-bat-tivi" src={`${CONDITIONER_TIVI_IMG_URI}ok-google-bat-tivi.jpg`}/>
          </Col>
        ...
        <Row className="conditioner-tivi__row google__row2" gutter={40}>
          ...
          <Col className="conditioner-tivi__row2__col2" span={12}>
            <img alt="bo-dieu-khien-hong-ngoai" src={`${CONDITIONER_TIVI_IMG_URI}bo-dieu-khien-hong-ngoai.png`}/>
          </Col>
        </Row>

        <div className="conditioner-tivi__panel smartphone-panel">
          <img alt="smartphone-panel" src={`${CONDITIONER_TIVI_IMG_URI}dieu-khien-dieu-hoa-qua-dt.jpg`}/>
        ...
        <Row className="conditioner-tivi__row conditioner-tivi__row3" gutter={40}>
          <Col className="conditioner-tivi__row3__col1" span={12}>
            <img alt="lap-ir" src={`${CONDITIONER_TIVI_IMG_URI}lap-ir.jpg`}/>
          </Col>
        ...
        <div className="conditioner-tivi__replace-remote">
          ...
          <img alt="thay-remote" src={`${CONDITIONER_TIVI_IMG_URI}thay-remote.jpg`}/>
        </div>
        ...
        <Row className="conditioner-tivi__row conditioner-tivi__row4" gutter={40}>
          ...
          <Col className="conditioner-tivi__row4__col2" span={12}>
            <img alt="bo-dieu-khien-hong-ngoai" src={`${CONDITIONER_TIVI_IMG_URI}bo-dieu-khien-hong-ngoai2.png`}/>
          </Col>
        </Row>
