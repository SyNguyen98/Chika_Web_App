...
import {GUEST_INTRODUCTION_IMG_URI} from "../../../constant/uri";
    ...
    return (
      <Fragment>
        <div className="introduce-header">
          <img alt="banner-introduce" src={`${GUEST_INTRODUCTION_IMG_URI}banner-introduce.png`} />
        ...
        <div className="introduce-timeline">
          <VerticalTimeline>
            <VerticalTimelineElement date="25/02/2019"
                                    ...
                                    icon={<img alt="icon-establish" src={`${GUEST_INTRODUCTION_IMG_URI}icon-establish.png`}/>}>
              <h2>THÀNH LẬP</h2>
              <p>
