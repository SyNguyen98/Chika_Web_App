            ...
            <div className="home-page">
                ...
                <div className="row">
                    <div className="content">
                        ...
                        <p>Là ngôi nhà có hệ thống đèn chiếu sáng, điều hòa, bình nóng lạnh, rèm cửa, âm thanh đa
                            vùng...
                            được điều khiển, kiểm soát trên smartphone dù ở bất cứ nơi đâu và bằng chính giọng nói của
                            gia chủ.</p>
                    </div>
                ...
                <div className="row">
                    ...
                    <div className="content">
                        ...
                        <p>Điều khiển nhà bằng giọng nói tiếng Việt. Nhà thông minh Chika được Google cấp chứng nhận
                            “Works with the Google Assistant”.</p>
                ...
                <div className="row">
                    <div className="content">
                        ...
                        <p>Bạn sẽ có không gian sinh động, một bữa tối lãng mạn, bữa tiệc sinh nhật ấn tượng với đèn Led
                            16 triệu sắc màu.</p>
                ...
                <div className="row">
                    <img alt="air-conditioner-tivi" src={`${GUEST_HOME_IMG_URI}air-conditioner-tivi.jpg`}
                ...
                <div className="panel light-control-panel" onClick={() => this.handleChangePage(LIGHT_CONTROL_LINK)}>
                    ...
                    <div className="content">
                        ...
                        <p>Cảm biến chuyển động, cảm biến cầu thang của Chika không dùng pin giúp đèn cầu thang, hành
                            lang...
