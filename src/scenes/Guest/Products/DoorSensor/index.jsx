...
import "./door-sensor.css";

import {DOOR_SENSOR_URI} from "../../../../constant/uri";
    ...
    return(
      <div className="door-sensor">
        <div className="door-sensor_introduce">
          <div className="door-sensor_introduce_image">
            <Carousel className="switch-sensor_introduce_carousel" autoplay dots='false'>
              <img alt="door-sensor" src={`${DOOR_SENSOR_URI}door-sensor.png`}/>
              <img alt="door-sensor" src={`${DOOR_SENSOR_URI}door-sensor-1.jpg`}/>
              <img alt="door-sensor" src={`${DOOR_SENSOR_URI}door-sensor-2.jpg`}/>
            </Carousel>
          </div>
        ...
        <div className="door-sensor_body">
          ...
          <br/><img alt="cam-bien-dot-nhap" src={`${DOOR_SENSOR_URI}cam-bien-dot-nhap.jpg`}/>
          ...
          <br/><img alt="cam-bien-dot-nhap-1" src={`${DOOR_SENSOR_URI}cam-bien-dot-nhap-1.jpg`}/>
          ...
          <br/><img alt="cam-bien-dot-nhap-2" src={`${DOOR_SENSOR_URI}cam-bien-dot-nhap-2.jpg`}/>
          ...
          <br/><img alt="cam-bien-dot-nhap-3" src={`${DOOR_SENSOR_URI}cam-bien-dot-nhap-3.jpg`}/>
