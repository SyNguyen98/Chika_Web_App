...
import {SWITCH_IMG_URI} from "../../../../constant/uri";
    ...
    return(
      <div className="switch">
        <div className="switch_introduce">
          <div className="switch_introduce_image">
            <Carousel className="switch-sensor_introduce_carousel" autoplay dots='false'>
              <img alt="ca-sw2" src={`${SWITCH_IMG_URI}ca-sw2-doc.png`}/>
              <img alt="ca-sw2" src={`${SWITCH_IMG_URI}ca-sw2-nghieng.png`}/>
              <img alt="ca-sw3" src={`${SWITCH_IMG_URI}ca-sw3-den.png`}/>
              <img alt="ca-sw3" src={`${SWITCH_IMG_URI}ca-sw3-trang.png`}/>
            </Carousel>
          </div>
        ...
        <div className="switch_body">
          ...
          <br/><img alt="switch" src={`${SWITCH_IMG_URI}ca-sw1.jpg`}/>
          ...
          <br/><img alt="switch" src={`${SWITCH_IMG_URI}ca-sw-mat-sau.jpg`}/>
          ...
          <br/><img alt="switch" src={`${SWITCH_IMG_URI}ca-sw2-doc.jpg`} style={{width: '40vw', marginLeft: '17vw'}}/>
          ...
          <br/><img alt="switch" src={`${SWITCH_IMG_URI}ca-sw3-den.png`} style={{width: '40vw', marginLeft: '17vw'}}/>
          ...
          <br/><img alt="switch" src={`${SWITCH_IMG_URI}ca-sw2-nghieng.jpg`} style={{width: '50vw', marginLeft: '15vw'}}/>
          ...
          <br/><img alt="switch" src={`${SWITCH_IMG_URI}ca-sw3-den.jpg`} style={{width: '45vw', marginLeft: '17vw'}}/>
          <br/><img alt="switch" src={`${SWITCH_IMG_URI}ca-sw3-trang.jpg`} style={{width: '45vw', marginLeft: '17vw'}}/>
