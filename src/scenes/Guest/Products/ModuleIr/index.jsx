...
import "./module-ir.css";

import {MODULE_IR_URI} from "../../../../constant/uri";
    ...
    return(
      <div className="module-ir">
        <div className="module-ir_introduce">
          <div className="module-ir_introduce_image">
            <Carousel className="switch-sensor_introduce_carousel" autoplay dots='false'>
              <img alt="ca-irx" src={`${MODULE_IR_URI}ca-irx.png`}/>
              <img alt="ca-irx" src={`${MODULE_IR_URI}ca-irx-1.png`}/>
              <img alt="ca-irx" src={`${MODULE_IR_URI}ca-irx-2.png`}/>
            </Carousel>
          </div>
        ...
        <div className="module-ir_body">
          ...
          <br/><img alt="cam-bien-hong-ngoai-1" src={`${MODULE_IR_URI}cam-bien-hong-ngoai-1.jpg`}/>
          ...
          <br/><img alt="cam-bien-hong-ngoai-2" src={`${MODULE_IR_URI}cam-bien-hong-ngoai-2.jpg`}/>
          ...
          <br/><img alt="cam-bien-hong-ngoai-3" src={`${MODULE_IR_URI}cam-bien-hong-ngoai-3.jpg`}/>
          ...
          <br/><img alt="cam-bien-hong-ngoai-4" src={`${MODULE_IR_URI}cam-bien-hong-ngoai-4.jpg`}/>
