...
import "./switch-sensor.css";

import {SWITCH_SENSOR_IMG_URI} from "../../../../constant/uri";
    ...
    return(
      <div className="switch-sensor">
        <div className="switch-sensor_introduce">
          <div className="switch-sensor_introduce_image">
            <Carousel className="switch-sensor_introduce_carousel" autoplay dots='false'>
              <img alt="switch" src={`${SWITCH_SENSOR_IMG_URI}switch-sensor-1.png`} />
              <img alt="switch" src={`${SWITCH_SENSOR_IMG_URI}switch-sensor-2.png`} />
              <img alt="switch" src={`${SWITCH_SENSOR_IMG_URI}switch-sensor-1.png`} />
              <img alt="switch" src={`${SWITCH_SENSOR_IMG_URI}switch-sensor-3.png`} />
            </Carousel>
          </div>
        ...
        <div className="switch-sensor_body">
          ...
          <br/><img alt="switch" src={`${SWITCH_SENSOR_IMG_URI}cong-tac-tich-hop-cam-bien-cau-thang.jpg`}/>
          <br/>+ Góc phát hiện chuyển động 2 : góc 35 .
          <br/><img alt="switch" src={`${SWITCH_SENSOR_IMG_URI}cong-tac-tich-hop-cam-bien-cau-thang-2.jpg`}/>
