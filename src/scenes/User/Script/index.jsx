...
export default class ListScriptComponent extends Component {
    ...
    handleCancelModal = () => {
        this.setState({addScriptModal: false})
    }
        ...
        return (
            <Fragment>
                <Row className="scripts">
                    ...
                    <Col className='scripts__item__add' span={6} onClick={this.handleOpenModal}>
                        <h2>THÊM KỊCH BẢN</h2>
                        <img alt="add-icon" src={`${ROOM_IMG_URI}add-icon.png`}/>
                    </Col>
                </Row>

                <AddScriptModal visible={this.state.addScriptModal} handleCancelModal={this.handleCancelModal}/>
            </Fragment>
