...
import {getAllModuleIr, saveModuleIr, deleteModuleIr} from '../../../../services/ProductService';
import TableComponent from '../../table';

export default class ModuleIrListComponent extends Component {
    constructor(props) {
        super(props);
        this.state = {
            moduleIrList: [],
            ...
            <div className="admin-device__list">
                ...
                <Modal visible={modalVisible}
                       ...
                       footer={[
                           ...
                           <Button disabled={disableAddModule} key="submit" type="primary"
