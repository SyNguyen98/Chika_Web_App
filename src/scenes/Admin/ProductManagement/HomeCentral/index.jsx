...
import {getAllHomeCenter, saveHomeCenter, deleteHomeCenter} from '../../../../services/ProductService';
import TableComponent from '../../table';

export default class HomeCentralListComponent extends Component {
    constructor(props) {
        super(props);
        this.state = {
            homeCenterList: [],
            ...
            <div className="admin-device__list">
                ...
                <Modal visible={modalVisible}
                       ...
                       footer={[
                           ...
                           <Button disabled={disableAddHomeCenter} key="submit" type="primary"
                                   onClick={this.handleAddHomeCenter}>
                               Thêm
                           </Button>,
                       ]}>
