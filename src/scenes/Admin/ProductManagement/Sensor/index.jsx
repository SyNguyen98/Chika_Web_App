...
import {getAllSensor, saveSensor, deleteSensor} from '../../../../services/ProductService';
            ...
            <div className="admin-device__list">
                ...
                <Modal visible={modalVisible}
                       ...
                       footer={[
                           ...
                           <Button disabled={disableAddSensor} key="submit" type="primary"
                                ...
                                {sensorType !== "SS01" ? (
                                    <span>
                                        ...
                                        <Input size='large'
                                               ...
                                               onChange={(e) => {
                                                   this.setState({sensorChannel: e.target.value})
                                               }}/>
                                    </span>
                                ) : null}
                            </div>
