...
import {updateProductWithUser} from '../../../../services/ProductService';
    ...
    handleFindUser = (phone) => {
        ...
        getUserByPhone(phone).then(response => {
            ...
            notification.error({
                ...
                description: error.message || 'Tải thông tin người dùng thất bại!'
            });
        });
    }
            ...
            <div className="admin-user_shop">
                ...
                <div className="admin-user_shop_content">
                    <div style={{width: '40vw'}}>
                        <AntPhoneForm findUser={this.handleFindUser} loading={isLoading}/>
                        {user ? (
                    ...
                    {user ? (<AntProductForm phone={user.phone}/>) : null}
                </div>
            </div>
        )
    }
